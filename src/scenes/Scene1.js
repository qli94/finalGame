class Scene1 extends Phaser.Scene{
    ...
    addTrash (){
        this.trash = this.physics.add.sprite(game.config.width,  Phaser.Math.Between(300, 400), "trash");
        this.trash.angle = 90;
   ...
   // }
    ...
    addPlatform(platformWidth, posX, posY){
        ...
        if(this.platformPool.getLength()){
            ...
            platform.tileScaleX = 2 / platform.scaleX;
        }
        else{
    ...
    update(){
       ...
       this.scenes.tilePositionX += this.scroll_speed;
        ...
        this.platformGroup.getChildren().forEach(function(platform){
            let platformDistance = game.config.width - platform.x - platform.displayWidth / 2.3;
            if(platformDistance < minDistance){
                minDistance = platformDistance;
                rightmostPlatformHeight = platform.y;
            }
            if(platform.x < - platform.displayWidth / 1.5){
