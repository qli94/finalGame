class Scene1 extends Phaser.Scene{
    ...
    create(){
        ...
        this.timedEvent = this.time.addEvent({ delay: 1000, callback: this.addTrash, callbackScope: this, loop: true });
        
    }


    addTrash (){
        this.trash = this.physics.add.sprite(game.config.width,  Phaser.Math.Between(300, 600), "trash");
        this.trash.angle = 90;
        this.trash.setVelocityX(-800);
    }
   //jump() {
