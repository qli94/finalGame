class Scene1 extends Phaser.Scene{
    ...
    create(){
        ...
        // monster
        this.monster = this.physics.add.sprite(game.config.width, 750 ,  'monster').setOrigin(0);
        //this.add.sprite(game.config.width, 500, 'monster').play('run');
        //this.monster.anims.play("rotate");
        this.monster.body.allowGravity = false;

        this.trash = this.physics.add.sprite(game.config.width, Math.random()*(490-420) + 220,  'trash').setOrigin(0);
        ...
        this.trash.body.setVelocityY(-400);

        this.trashes = this.add.group();
        this.trashes.add(this.trash);
        ...
        this.physics.add.collider(this.trashes, this.player, ()=>{
            this.player.setVelocityX(0);
            this.player.setVelocityY(0);
            this.playerState--;
        });

        this.physics.add.overlap(this.player, this.fireGroup, function(player, trash){
